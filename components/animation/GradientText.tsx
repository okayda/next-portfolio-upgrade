...
export default function GradientText({ text = "Your text" }: { text: string }) {
  return (
    <div>
      <div className="group relative mx-auto flex max-w-fit flex-row items-center justify-center rounded-2xl bg-[#03001417] px-3 py-1 font-medium shadow-[inset_0_-8px_10px_#8fdfff1f] backdrop-blur-sm transition-shadow duration-500 ease-out [--bg-size:300%] hover:shadow-[inset_0_-5px_10px_#8fdfff3f]">
        <div
