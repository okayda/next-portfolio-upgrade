    ...
    <article itemScope itemType="https://schema.org/BlogPosting">
      ...
      <div itemProp="articleBody" className="mx-auto max-w-[800px]">
        ...
        <p className="mb-10 text-gray-300">
          ...
          JavaScript, especially when dealing with tasks like fetching data from
          an API or performing some mutation.
        </p>
        ...
        <p className="mb-10 text-gray-300">
          ...
          database, handling these asynchronous tasks efficiently is essential.
          In the past, JavaScript developers had to rely on{" "}
          <strong>callbacks</strong>, leading to the infamous{" "}
          <strong>callback hell</strong>. Later <strong>promises</strong>{" "}
          arrived as a solution, but chaining them could still lead to unwieldy
          code. Thankfully <strong>async/await</strong> has emerged as a
          powerful and intuitive way, making code readable & efficient.
        </p>
        ...
        <p className="mb-3 text-gray-300">
          ...
          JavaScript. A callback is a function passed as an argument to another
...
console.log("Data received: ", data);
        ...
        <p className="mb-3 mt-3 text-gray-300">
          While callbacks work, they can lead to <strong>callback hell</strong>{" "}
          when dealing with multiple asynchronous operations, making code hard
          to read & maintain.
        </p>
 ...
 if (isValid)  {
   ...
   console.error("Data validation failed");
        ...
        <p className="mb-3 text-gray-300">
          ...
          promise represents a value that may be available now, in the future or
          never.
        </p>
...
console.log(data);
        ...
        <p className="mb-10 text-gray-300">
          By choosing the right tool for the job and understanding the strengths
          and weaknesses of each approach, you can write efficient, readable, &
          maintainable code.
        </p>

        <p className="mb-10 text-gray-300">
          <strong>Use async/await</strong> for most of your asynchronous code to
          write clean & maintainable code. This does not mean you should not use
          callbacks & promises anymore.
        </p>

        <p className="mb-10 text-gray-300">
          <strong>Understanding callbacks & promises</strong> is very crucial,
          especially if you want to maintain or work with certain libraries and
          codebases that rely on them. In some cases, especially when working
          with older APIs or codebases, callbacks & promises might still be
          used. Knowing how to work with them ensures compatibility and the
          ability to refactor or integrate legacy code.
        </p>
        ...
        <p className="mb-3 text-gray-300">
          ...
          automatically returns a Promise. Inside this function, you can use the{" "}
          <code>await</code> keyword, which pauses the function execution until
          that Promise settles (either fulfilled or rejected).
        </p>
...
return response.json();
        ...
        <p className="mb-10 mt-3 text-gray-300">
          ...
          API, error handling is very crucial due to the unpredictable nature of
          network requests. Servers can be unstable, APIs might be down or
          responses might not be in the expected format. Without error handling,
          your application can encounter runtime errors that are hard to debug.
        </p>
        ...
        <p className="mb-3 text-gray-300">
          ...
          <strong>try...catch</strong> blocks. This way, we can catch exceptions
          thrown during the asynchronous operations and handle them properly.
        </p>
...
throw error;
        ...
        <ul className="mb-10 list-disc pl-5 text-gray-300">
          <li className="mb-2">
            <strong>Unstable APIs/Servers:</strong> External APIs & servers can
            be unreliable. Network issues, server downtime, or incorrect
            endpoints can cause requests to fail.
          </li>
          <li className="mb-2">
            <strong>Runtime Errors:</strong> Without proper error handling, your
            application might crash or behave unexpectedly when an error occur.
          </li>
          <li className="mb-2">
        ...
        <p className="mb-10 text-gray-300">
          ...
          operations. I will not dive deeply into this topic since event loop is
          a broad topic, but here is a simple overview of how asynchronous
          execution works.
        </p>
        ...
        <p className="mb-3 text-gray-300">
          ...
          <strong>Queue</strong> (where callbacks, promises, & async/await tasks
          wait to be executed).
        </p>
        ...
        <p className="mb-10 text-gray-300">
          Consider a scenario where you need to fetch data from multiple URLs. A
          common mistake is to use <code>await</code> inside a loop, which
...
console.log(data);
        ...
        <p className="mb-10 mt-3 text-gray-300">
          ...
          previous one to finish. If you have five URLs, the total time will be
          roughly the sum of the time taken by each request.
        </p>
...
console.error("Error fetching data: ", error);
        ...
        <p className="mb-10 text-gray-300">
          Running asynchronous operations in parallel can drastically reduce the
          total execution time. Instead of waiting for each operation to
        ...
        <p className="text-gray-300">
          In my own journey, embracing <strong>async/await</strong> has not only
          improved the quality of my code but also enhanced my productivity as a
          developer. I encourage you to dive deep into async/await, experiment
          with advanced patterns, and see how it can transform your approach.
        </p>
      </div>
    </article>
  );
